...
const About = () => {
  return (
    <section id="about" className="bg-brand-beige min-h-screen py-24 px-6 sm:px-12 flex items-center justify-center overflow-hidden">
      <div className="max-w-7xl w-full grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
        ...
        <div className="lg:col-span-6 space-y-8 animate-fade-in">
          <div className="space-y-4">
            <h2 className="text-5xl sm:text-6xl font-black italic text-brand-green leading-tight">
        ...
        <div className="lg:col-span-6 relative flex items-center justify-center min-h-[500px]">
          {/* Main Large Image */}
          <div className="relative z-10 w-64 h-64 sm:w-80 sm:h-80 md:w-96 md:h-96 rounded-full overflow-hidden border-8 border-white shadow-2xl transform hover:rotate-6 transition-transform duration-700">
            <img 
          ...
          <div className="absolute top-0 right-10 z-20 w-24 h-24 sm:w-32 sm:h-32 md:w-40 md:h-40 rounded-full overflow-hidden border-4 border-white shadow-xl animate-bounce-slow">
            <img 
          ...
          <div className="absolute -bottom-10 left-0 sm:left-10 z-20 w-32 h-32 sm:w-40 sm:h-40 md:w-48 md:h-48 rounded-full overflow-hidden border-4 border-white shadow-xl hover:scale-110 transition-transform duration-500">
            <img 
          ...
          <div className="absolute top-1/2 -left-10 transform -translate-y-1/2 z-0 w-20 h-20 sm:w-28 sm:h-28 md:w-32 md:h-32 rounded-full overflow-hidden border-4 border-white shadow-lg opacity-80">
            <img 
