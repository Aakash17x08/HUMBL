...
const Contact = () => {
  return (
    <section id="contact" className="bg-white min-h-screen py-24 sm:py-32 px-4 sm:px-8 md:px-12 flex flex-col items-center overflow-hidden w-full">
            ...
            <div className="space-y-8">
              <div className="flex items-center gap-6 group">
                ...
                <div>
                  ...
                  <p className="text-xl font-black italic text-brand-green">hello@gohumbl.com</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-6 group">
                ...
                <div>
                  ...
                  <p className="text-xl font-black italic text-brand-green">Pune, Maharashtra, India</p>
                </div>
              </div>
            </div>
