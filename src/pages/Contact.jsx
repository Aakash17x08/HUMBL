...
const Contact = () => {
  return (
    <section
      id="contact"
      className="bg-white min-h-screen py-24 sm:py-32 px-4 sm:px-8 md:px-12 flex flex-col items-center overflow-hidden w-full"
    >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
          ...
          <div className="space-y-12">
            <h2 className="text-4xl font-black italic text-brand-green leading-tight">
              ...
              <span className="text-brand-pink">community</span> together.
            </h2>
            ...
            <div className="space-y-8">
              <div className="flex items-center gap-6 group">
                ...
                <div>
                  <p className="text-xs font-black uppercase tracking-widest text-brand-green/50 mb-1">
                    Email Us
                  </p>
                  <p className="text-xl font-black italic text-brand-green">
                    hello@gohumbl.com
                  </p>
                </div>
              </div>
            ...
            <div className="pt-8">
              <p className="text-sm font-black uppercase tracking-widest text-brand-green/40 mb-6">
                Follow our journey
              </p>
              <div className="flex gap-4">
                {[Instagram, Twitter, Facebook].map((Icon, i) => (
                  <a
                    key={i}
                    href="#"
                    className="bg-brand-green text-white p-4 rounded-full hover:bg-brand-dark transition-all shadow-lg hover:-translate-y-1"
                  >
                    <Icon size={24} />
                  </a>
                ))}
            ...
            <form className="space-y-8">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
                <div className="space-y-2">
                  <label className="text-xs font-black uppercase tracking-widest text-brand-green/60 ml-2">
                    Your Name
                  </label>
                  <input
                    type="text"
                ...
                <div className="space-y-2">
                  ...
                  <input
                    type="email"
                    placeholder="gohumbl@example.com"
                    className="w-full bg-white/50 border-2 border-brand-green/5 rounded-2xl py-4 px-6 font-bold italic outline-none focus:border-brand-green transition-all"
                  />
                </div>
              </div>
